...
/**
 * Occurrence ids the user confirmed natively ("Done") that still need to be
 * POSTed to the server. The WebView drains these (it holds the session cookie)
 * via AlarmPlugin.drainPendingAcks().
 */
object PendingAckStore {
    private const val PREFS = "persistent_alarms"
    private const val KEY = "pending_acks"
