...
class AlarmReceiver : BroadcastReceiver() {
    ...
    companion object {
        ...
        // Android Auto's own Done/Snooze buttons reuse ACTION_CONFIRM and ACTION_SNOOZE
        // above: the car needs no receiver actions of its own (see CarNotificationProjection).
